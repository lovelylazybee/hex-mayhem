...
function seedData() {
  ...
  if (hextechCount.count === 0) {
    const hextechData = [
      ...
      { name: "双发快射", slug: "双发快射-silver", tier: "silver", description: "获得30%攻击速度。\n你的攻击会发射第二枚子弹，造成25%攻击力的物理伤害并施加100%的攻击特效。", imageUrl: "/hextech/双发快射.webp" },
      { name: "古式佳酿", slug: "古式佳酿-silver", tier: "silver", description: "获得15技能急速。你的技能会留下一滩持续3秒的酒池，减速30%并每秒造成8-40（基于等级）魔法伤害。", imageUrl: "/hextech/古式佳酿.webp" },
      ...
      { name: "吸血习性", slug: "吸血习性-silver", tier: "silver", description: "获得8%全能吸血。", imageUrl: "/hextech/吸血习性.webp" },
      { name: "咏叹奏明", slug: "咏叹奏明-silver", tier: "silver", description: "获得15技能急速。你的技能在命中敌方英雄时为你回复4-24（基于等级）生命值。", imageUrl: "/hextech/咏叹奏明.webp" },
      { name: "回力OK镖", slug: "回力OK镖-silver", tier: "silver", description: "你的远程普通攻击会弹射到1个额外目标，造成50%攻击力的物理伤害。", imageUrl: "/hextech/回力OK镖.webp" },
      { name: "回归基本功", slug: "回归基本功-silver", tier: "silver", description: "获得15攻击力。", imageUrl: "/hextech/回归基本功.webp" },
      { name: "坚韧", slug: "坚韧-silver", tier: "silver", description: "获得100额外生命值。", imageUrl: "/hextech/坚韧.webp" },
      { name: "基石法师", slug: "基石法师-silver", tier: "silver", description: "获得25法术强度。", imageUrl: "/hextech/基石法师.webp" },
      { name: "大力", slug: "大力-silver", tier: "silver", description: "获得15攻击力和15%攻击速度。", imageUrl: "/hextech/大力.webp" },
      { name: "夺金", slug: "夺金-silver", tier: "silver", description: "获得2金币/秒的被动收入。", imageUrl: "/hextech/夺金.webp" },
      { name: "家园卫士", slug: "家园卫士-silver", tier: "silver", description: "在泉水时获得75%额外移动速度，持续1.5秒。", imageUrl: "/hextech/家园卫士.webp" },
      { name: "小丑学院", slug: "小丑学院-silver", tier: "silver", description: "你的技能可以暴击，造成20%额外伤害。获得25%暴击几率。", imageUrl: "/hextech/小丑学院.webp" },
      { name: "尖端发明家", slug: "尖端发明家-silver", tier: "silver", description: "获得20技能急速。", imageUrl: "/hextech/尖端发明家.webp" },
      { name: "尤里卡", slug: "尤里卡-silver", tier: "silver", description: "获得20技能急速和15法术强度。", imageUrl: "/hextech/尤里卡.webp" },
      { name: "属性！", slug: "属性！-silver", tier: "silver", description: "获得5攻击力、5法术强度、5额外生命值、5%攻击速度、5技能急速、5%全能吸血。", imageUrl: "/hextech/属性！.webp" },
      { name: "巨人杀手", slug: "巨人杀手-silver", tier: "silver", description: "对最大生命值高于你的敌人造成5%额外伤害。", imageUrl: "/hextech/巨人杀手.webp" },
      { name: "弹球", slug: "弹球-silver", tier: "silver", description: "你的单体技能会在命中后弹射到附近1个敌人身上，造成30%的伤害。", imageUrl: "/hextech/弹球.webp" },
      { name: "强力护盾", slug: "强力护盾-silver", tier: "silver", description: "获得一个持续3秒的护盾，可吸收50-150（基于等级）伤害（15秒冷却时间）。", imageUrl: "/hextech/强力护盾.webp" },
      { name: "循环往复", slug: "循环往复-silver", tier: "silver", description: "获得15技能急速。在你施放终极技能后，返还其20%冷却时间。", imageUrl: "/hextech/循环往复.webp" },
      { name: "心灵净化", slug: "心灵净化-silver", tier: "silver", description: "获得30%韧性。", imageUrl: "/hextech/心灵净化.webp" },
      { name: "急急小子", slug: "急急小子-silver", tier: "silver", description: "获得10%移动速度。", imageUrl: "/hextech/急急小子.webp" },
      { name: "急救用具", slug: "急救用具-silver", tier: "silver", description: "获得15%治疗和护盾强度。", imageUrl: "/hextech/急救用具.webp" },
      { name: "感受燃烧", slug: "感受燃烧-silver", tier: "silver", description: "你的伤害型技能会在命中时施加持续3秒的灼烧效果，共造成8-30（基于等级）魔法伤害。", imageUrl: "/hextech/感受燃烧.webp" },
      { name: "战争交响乐", slug: "战争交响乐-silver", tier: "silver", description: "获得15攻击力和15法术强度。", imageUrl: "/hextech/战争交响乐.webp" },
      ...
      { name: "接二连三", slug: "接二连三-silver", tier: "silver", description: "在你对一名敌方英雄造成伤害后的3秒内，你的下一次攻击或技能对其造成15额外魔法伤害（2秒冷却时间）。", imageUrl: "/hextech/接二连三.webp" },
      { name: "无休回复", slug: "无休回复-silver", tier: "silver", description: "获得2%已损失生命值/秒的生命回复。", imageUrl: "/hextech/无休回复.webp" },
      { name: "易损", slug: "易损-silver", tier: "silver", description: "你对敌人造成的前6次攻击或技能造成5%额外伤害。", imageUrl: "/hextech/易损.webp" },
      { name: "星界躯体", slug: "星界躯体-silver", tier: "silver", description: "获得150额外生命值，但你的伤害降低8%。", imageUrl: "/hextech/星界躯体.webp" },
      { name: "暗影疾奔", slug: "暗影疾奔-silver", tier: "silver", description: "获得15%移动速度。在脱离战斗后，额外获得15%移动速度。", imageUrl: "/hextech/暗影疾奔.webp" },
      { name: "暴击律动", slug: "暴击律动-silver", tier: "silver", description: "获得25%暴击几率。", imageUrl: "/hextech/暴击律动.webp" },
      ...
      { name: "溢流", slug: "溢流-silver", tier: "silver", description: "获得20法术强度。你的法力值溢出时，将溢出部分转化为法术强度（1%法力值=1法术强度）。", imageUrl: "/hextech/溢流.webp" },
      { name: "激光治疗", slug: "激光治疗-silver", tier: "silver", description: "获得15%治疗和护盾强度。你的治疗和护盾效果在目标生命值低于40%时增强15%。", imageUrl: "/hextech/激光治疗.webp" },
      { name: "灵巧", slug: "灵巧-silver", tier: "silver", description: "获得10%闪避几率。", imageUrl: "/hextech/灵巧.webp" },
      { name: "炼狱导管", slug: "炼狱导管-silver", tier: "silver", description: "获得15法术穿透。", imageUrl: "/hextech/炼狱导管.webp" },
      { name: "物法皆修", slug: "物法皆修-silver", tier: "silver", description: "获得15攻击力和25法术强度。", imageUrl: "/hextech/物法皆修.webp" },
      { name: "狂徒豪气", slug: "狂徒豪气-silver", tier: "silver", description: "获得300额外生命值。如果你在6秒内没有受到伤害，每秒回复5%最大生命值。", imageUrl: "/hextech/狂徒豪气.webp" },
      { name: "珠光护手", slug: "珠光护手-silver", tier: "silver", description: "获得25%暴击几率和15法术强度。", imageUrl: "/hextech/珠光护手.webp" },
      { name: "由心及物", slug: "由心及物-silver", tier: "silver", description: "获得等同于15%额外法术强度的攻击力。", imageUrl: "/hextech/由心及物.webp" },
      { name: "砍伤", slug: "砍伤-silver", tier: "silver", description: "获得15攻击力。你的攻击对敌人施加持续5秒的【砍伤】效果，每秒造成2-8（基于等级）物理伤害。", imageUrl: "/hextech/砍伤.webp" },
      { name: "神圣干预", slug: "神圣干预-silver", tier: "silver", description: "当你受到致命伤害时，免疫该伤害并在2秒内回复10%最大生命值（120秒冷却时间）。", imageUrl: "/hextech/神圣干预.webp" },
      { name: "精准奇才", slug: "精准奇才-silver", tier: "silver", description: "获得15%攻击速度和15攻击力。", imageUrl: "/hextech/精准奇才.webp" },
      { name: "红包", slug: "红包-silver", tier: "silver", description: "每60秒获得一个红包，打开后获得随机金币。", imageUrl: "/hextech/红包.webp" },
      { name: "练腿日", slug: "练腿日-silver", tier: "silver", description: "获得15%移动速度和100额外生命值。", imageUrl: "/hextech/练腿日.webp" },
      { name: "缩小射线", slug: "缩小射线-silver", tier: "silver", description: "你的下一个攻击会缩小目标，使其造成的伤害降低10%并减少10%移动速度，持续3秒（8秒冷却时间）。", imageUrl: "/hextech/缩小射线.webp" },
      { name: "老练狙神", slug: "老练狙神-silver", tier: "silver", description: "获得15攻击力。你的远程攻击在最大射程命中时造成10%额外伤害。", imageUrl: "/hextech/老练狙神.webp" },
      ...
      { name: "闪电打击", slug: "闪电打击-silver", tier: "silver", description: "每3次攻击会释放一道闪电，对目标造成30-100（基于等级）魔法伤害。", imageUrl: "/hextech/闪电打击.webp" },
      { name: "防护面纱", slug: "防护面纱-silver", tier: "silver", description: "获得一个法术护盾，可抵挡一次敌方技能（30秒冷却时间）。", imageUrl: "/hextech/防护面纱.webp" },
      { name: "面包和黄油", slug: "面包和黄油-silver", tier: "silver", description: "获得5攻击力、5法术强度、100生命值。", imageUrl: "/hextech/面包和黄油.webp" },
      { name: "风语者的祝福", slug: "风语者的祝福-silver", tier: "silver", description: "获得10%治疗和护盾强度。你对友方施加的治疗和护盾效果额外增加10%。", imageUrl: "/hextech/风语者的祝福.webp" },
      { name: "飞身踢", slug: "飞身踢-silver", tier: "silver", description: "你的冲刺技能会在终点造成40-120（基于等级）物理伤害。", imageUrl: "/hextech/飞身踢.webp" },
      { name: "魄罗爆破手", slug: "魄罗爆破手-silver", tier: "silver", description: "你的技能会在命中位置生成一个魄罗，1秒后爆炸造成20-60（基于等级）魔法伤害。", imageUrl: "/hextech/魄罗爆破手.webp" },
      { name: "魔法飞弹", slug: "魔法飞弹-silver", tier: "silver", description: "你的技能命中时会发射3枚魔法飞弹，每枚造成5-20（基于等级）魔法伤害。", imageUrl: "/hextech/魔法飞弹.webp" },
      ...
      { name: "万用瞄准镜", slug: "万用瞄准镜-gold", tier: "gold", description: "获得75额外攻击距离。", imageUrl: "/hextech/万用瞄准镜.webp" },
      { name: "不动如山", slug: "不动如山-gold", tier: "gold", description: "获得30护甲和30魔法抗性。在你站立不动1秒后，获得额外30护甲和30魔法抗性。", imageUrl: "/hextech/不动如山.webp" },
      { name: "不祥契约", slug: "不祥契约-gold", tier: "gold", description: "获得40法术强度。你受到的30%伤害会转化为持续3秒的债务，而非立即扣除。", imageUrl: "/hextech/不祥契约.webp" },
      { name: "亮出你的剑", slug: "亮出你的剑-gold", tier: "gold", description: "获得25攻击力和25%攻击速度。你的攻击在命中时获得一层【亮剑】，在5层时，你的下一次攻击造成50额外物理伤害。", imageUrl: "/hextech/亮出你的剑.webp" },
      ...
      { name: "你摸不到", slug: "你摸不到-gold", tier: "gold", description: "获得20%闪避几率。成功闪避后，获得30%移动速度，持续1秒。", imageUrl: "/hextech/你摸不到.webp" },
      { name: "你肩上的恶魔", slug: "你肩上的恶魔-gold", tier: "gold", description: "获得25攻击力。你的技能命中敌方英雄时，恶魔会对其造成15-50（基于等级）额外魔法伤害（3秒冷却时间）。", imageUrl: "/hextech/你肩上的恶魔.webp" },
      { name: "信念者的强化", slug: "信念者的强化-gold", tier: "gold", description: "获得20%韧性和20%减速抵抗。", imageUrl: "/hextech/信念者的强化.webp" },
      { name: "俯冲轰炸", slug: "俯冲轰炸-gold", tier: "gold", description: "你的冲刺/位移技能会在路径上留下炸弹，1秒后爆炸造成60-180（基于等级）魔法伤害。", imageUrl: "/hextech/俯冲轰炸.webp" },
      { name: "全凭身法", slug: "全凭身法-gold", tier: "gold", description: "获得15%闪避几率。闪避攻击后，获得20%攻击速度，持续2秒。", imageUrl: "/hextech/全凭身法.webp" },
      ...
      { name: "冰霜幽灵", slug: "冰霜幽灵-gold", tier: "gold", description: "你的减速效果可使移动速度降低额外的50。被你减速的敌人受到8%额外伤害。", imageUrl: "/hextech/冰霜幽灵.webp" },
      { name: "刃下生风", slug: "刃下生风-gold", tier: "gold", description: "获得15%攻击速度。你的普通攻击在命中时获得3%移动速度（至多叠加5次）。", imageUrl: "/hextech/刃下生风.webp" },
      { name: "利刃华尔兹", slug: "利刃华尔兹-gold", tier: "gold", description: "获得25%攻击速度。你的普通攻击在命中时获得一层【舞步】，在4层时，你的下一次攻击对目标周围敌人造成40%攻击力的物理伤害。", imageUrl: "/hextech/利刃华尔兹.webp" },
      { name: "双刀流", slug: "双刀流-gold", tier: "gold", description: "获得25%攻击速度。你的普通攻击会同时用副武器攻击，造成30%攻击力的物理伤害。", imageUrl: "/hextech/双刀流.webp" },
      { name: "双生火焰", slug: "双生火焰-gold", tier: "gold", description: "获得30法术强度。你的单体技能在命中后会复制一次，造成30%的伤害。", imageUrl: "/hextech/双生火焰.webp" },
      { name: "史上最大雪球", slug: "史上最大雪球-gold", tier: "gold", description: "获得300额外生命值。你的技能命中的敌人越多，造成的伤害越高（每多命中一个敌人增加10%伤害）。", imageUrl: "/hextech/史上最大雪球.webp" },
      { name: "吞噬灵魂", slug: "吞噬灵魂-gold", tier: "gold", description: "获得20法术强度。击杀或助攻后，获得10法术强度（至多叠加5次），死亡后损失一半层数。", imageUrl: "/hextech/吞噬灵魂.webp" },
      { name: "和我一起困在这里", slug: "和我一起困在这里-gold", tier: "gold", description: "获得40额外生命值和10护甲。在你被定身时，定身你的敌人也会被定身0.5秒。", imageUrl: "/hextech/和我一起困在这里.webp" },
      { name: "唯快不破", slug: "唯快不破-gold", tier: "gold", description: "获得20%攻击速度和15%暴击几率。你的攻击速度超过2.0时，攻击造成10%额外伤害。", imageUrl: "/hextech/唯快不破.webp" },
      { name: "圣火", slug: "圣火-gold", tier: "gold", description: "获得20法术强度。你的技能命中时点燃目标，在3秒内造成20-60（基于等级）魔法伤害。", imageUrl: "/hextech/圣火.webp" },
      { name: "地狱三头犬", slug: "地狱三头犬-gold", tier: "gold", description: "获得丛刃和强攻符文。", imageUrl: "/hextech/地狱三头犬.webp" },
      { name: "坚若磐石", slug: "坚若磐石-gold", tier: "gold", description: "获得30护甲和30魔法抗性。在你生命值低于30%时，额外获得20护甲和20魔法抗性。", imageUrl: "/hextech/坚若磐石.webp" },
      ...
      { name: "天音爆", slug: "天音爆-gold", tier: "gold", description: "获得25法术强度。你的技能命中3次后，下一次技能造成30额外魔法伤害并沉默目标0.5秒。", imageUrl: "/hextech/天音爆.webp" },
      { name: "尊我为王", slug: "尊我为王-gold", tier: "gold", description: "获得25攻击力。击杀或助攻后，获得10攻击力（至多叠加5次），死亡后损失一半层数。", imageUrl: "/hextech/尊我为王.webp" },
      { name: "小猫咪找妈妈", slug: "小猫咪找妈妈-gold", tier: "gold", description: "获得15%移动速度。靠近友军时，双方获得10%移动速度。", imageUrl: "/hextech/小猫咪找妈妈.webp" },
      { name: "属性叠属性！", slug: "属性叠属性！-gold", tier: "gold", description: "获得10攻击力、10法术强度、100生命值、10%攻击速度、10技能急速、5%全能吸血。", imageUrl: "/hextech/属性叠属性！.webp" },
      { name: "巨像的勇气", slug: "巨像的勇气-gold", tier: "gold", description: "获得400额外生命值。你的硬控技能会赋予你一个持续3秒的护盾，可吸收50-150（基于等级）伤害。", imageUrl: "/hextech/巨像的勇气.webp" },
      { name: "帽上加帽", slug: "帽上加帽-gold", tier: "gold", description: "获得40法术强度。你的法术强度增加15%。", imageUrl: "/hextech/帽上加帽.webp" },
      { name: "当心小蛋糕！", slug: "当心小蛋糕！-gold", tier: "gold", description: "在你附近放置一个隐形的蛋糕陷阱。踩到的敌人会被减速40%并受到80-200（基于等级）魔法伤害（20秒冷却时间）。", imageUrl: "/hextech/当心小蛋糕！.webp" },
      { name: "快中求稳", slug: "快中求稳-gold", tier: "gold", description: "获得20%攻击速度和15护甲。", imageUrl: "/hextech/快中求稳.webp" },
      { name: "慢炖", slug: "慢炖-gold", tier: "gold", description: "获得30法术强度。你对同一敌人的持续伤害效果增加15%。", imageUrl: "/hextech/慢炖.webp" },
      { name: "扳机炼狱", slug: "扳机炼狱-gold", tier: "gold", description: "获得25%攻击速度和20%暴击几率。你的暴击会触发一次额外攻击，造成50%攻击力的物理伤害。", imageUrl: "/hextech/扳机炼狱.webp" },
      { name: "捐赠", slug: "捐赠-gold", tier: "gold", description: "你附近友军获得5%移动速度和5%攻击速度。", imageUrl: "/hextech/捐赠.webp" },
      { name: "无限循环往复", slug: "无限循环往复-gold", tier: "gold", description: "获得25技能急速。在你施放终极技能后，返还其40%冷却时间。", imageUrl: "/hextech/无限循环往复.webp" },
      ...
      { name: "杀意翻涌", slug: "杀意翻涌-gold", tier: "gold", description: "获得25攻击力。你的攻击在命中低于50%生命值的敌人时造成10%额外伤害。", imageUrl: "/hextech/杀意翻涌.webp" },
      { name: "歌利亚巨人", slug: "歌利亚巨人-gold", tier: "gold", description: "获得500额外生命值。", imageUrl: "/hextech/歌利亚巨人.webp" },
      { name: "死亡之环", slug: "死亡之环-gold", tier: "gold", description: "获得30法术强度。你的范围技能的半径增加15%。", imageUrl: "/hextech/死亡之环.webp" },
      { name: "残忍", slug: "残忍-gold", tier: "gold", description: "获得20攻击力。你对减速、定身或禁锢的敌人造成10%额外伤害。", imageUrl: "/hextech/残忍.webp" },
      { name: "残暴之力", slug: "残暴之力-gold", tier: "gold", description: "获得25攻击力和15护甲穿透。", imageUrl: "/hextech/残暴之力.webp" },
      { name: "海克斯龙魂", slug: "海克斯龙魂-gold", tier: "gold", description: "你获得海克斯龙魂，获得所有龙魂效果的弱化版本。", imageUrl: "/hextech/海克斯龙魂.webp" },
      { name: "渴血", slug: "渴血-gold", tier: "gold", description: "获得15攻击力和10%物理吸血。", imageUrl: "/hextech/渴血.webp" },
      { name: "火上浇油", slug: "火上浇油-gold", tier: "gold", description: "获得30法术强度。你对已受灼烧效果影响的敌人造成15%额外伤害。", imageUrl: "/hextech/火上浇油.webp" },
      { name: "火狐", slug: "火狐-gold", tier: "gold", description: "获得25法术强度和10%移动速度。你的技能命中时获得5%移动速度，持续2秒（至多叠加3次）。", imageUrl: "/hextech/火狐.webp" },
      { name: "灵魂虹吸", slug: "灵魂虹吸-gold", tier: "gold", description: "获得20法术强度和8%法术吸血。", imageUrl: "/hextech/灵魂虹吸.webp" },
      { name: "炼狱龙魂", slug: "炼狱龙魂-gold", tier: "gold", description: "你获得炼狱龙魂，你的攻击和技能会灼烧敌人。", imageUrl: "/hextech/炼狱龙魂.webp" },
      ...
      { name: "物理转魔法", slug: "物理转魔法-gold", tier: "gold", description: "获得20攻击力。你的攻击力15%转化为法术强度。", imageUrl: "/hextech/物理转魔法.webp" },
      { name: "狂热者", slug: "狂热者-gold", tier: "gold", description: "获得25%攻击速度和15%暴击几率。", imageUrl: "/hextech/狂热者.webp" },
      { name: "玻璃大炮", slug: "玻璃大炮-gold", tier: "gold", description: "获得30攻击力和30法术强度。你受到的伤害增加10%。", imageUrl: "/hextech/玻璃大炮.webp" },
      { name: "生机迸发", slug: "生机迸发-gold", tier: "gold", description: "获得200额外生命值和50%基础生命回复。", imageUrl: "/hextech/生机迸发.webp" },
      { name: "由暴生急", slug: "由暴生急-gold", tier: "gold", description: "获得20%暴击几率。你的暴击几率的30%转化为技能急速。", imageUrl: "/hextech/由暴生急.webp" },
      { name: "男爵之手", slug: "男爵之手-gold", tier: "gold", description: "获得30攻击力和15护甲穿透。你的攻击对建筑造成50%额外伤害。", imageUrl: "/hextech/男爵之手.webp" },
      { name: "砸开那颗蛋", slug: "砸开那颗蛋-gold", tier: "gold", description: "获得25攻击力。你的攻击对护盾造成200%伤害。", imageUrl: "/hextech/砸开那颗蛋.webp" },
      ...
      { name: "神圣雪球", slug: "神圣雪球-gold", tier: "gold", description: "获得200额外生命值。你的技能命中的每个敌方英雄赋予你一个雪球层数，在5层时消耗所有层数回复10%最大生命值。", imageUrl: "/hextech/神圣雪球.webp" },
      { name: "神射法师", slug: "神射法师-gold", tier: "gold", description: "获得25法术强度和15%攻击速度。你的普通攻击造成15额外魔法伤害。", imageUrl: "/hextech/神射法师.webp" },
      { name: "科学狂人", slug: "科学狂人-gold", tier: "gold", description: "获得25法术强度和15技能急速。", imageUrl: "/hextech/科学狂人.webp" },
      { name: "秘术冲拳", slug: "秘术冲拳-gold", tier: "gold", description: "获得20攻击力和20法术强度。你的冲刺技能在命中敌人时造成30-90（基于等级）额外魔法伤害。", imageUrl: "/hextech/秘术冲拳.webp" },
      ...
      { name: "精怪魔法", slug: "精怪魔法-gold", tier: "gold", description: "获得30法术强度。你的技能有15%几率造成25%额外伤害。", imageUrl: "/hextech/精怪魔法.webp" },
      { name: "纯粹主义者-术师", slug: "纯粹主义者-术师-gold", tier: "gold", description: "获得40法术强度。你只能造成魔法伤害。", imageUrl: "/hextech/纯粹主义者-术师.webp" },
      { name: "终极不可阻挡", slug: "终极不可阻挡-gold", tier: "gold", description: "获得30护甲和30魔法抗性。施放终极技能后，获得免疫控制效果，持续2秒。", imageUrl: "/hextech/终极不可阻挡.webp" },
      { name: "终极刷新", slug: "终极刷新-gold", tier: "gold", description: "获得20技能急速。在你施放终极技能后的3秒内，你的非终极技能冷却速度提高50%。", imageUrl: "/hextech/终极刷新.webp" },
      { name: "终极唤醒", slug: "终极唤醒-gold", tier: "gold", description: "获得20技能急速。在你施放终极技能后的5秒内，你获得30攻击力和30法术强度。", imageUrl: "/hextech/终极唤醒.webp" },
      ...
      { name: "至高天诺言", slug: "至高天诺言-gold", tier: "gold", description: "获得20攻击力和20法术强度。在击杀或助攻后，回复15%最大生命值和法力值。", imageUrl: "/hextech/至高天诺言.webp" },
      { name: "舞会女王", slug: "舞会女王-gold", tier: "gold", description: "获得20%移动速度和25%攻击速度。你的移动距离越远，下一次攻击造成的伤害越高（至多增加30%）。", imageUrl: "/hextech/舞会女王.webp" },
      { name: "虚幻武器", slug: "虚幻武器-gold", tier: "gold", description: "获得20攻击力。你的攻击力10%转化为法术强度。你的法术强度10%转化为攻击力。", imageUrl: "/hextech/虚幻武器.webp" },
      { name: "蛋白粉奶昔", slug: "蛋白粉奶昔-gold", tier: "gold", description: "获得200额外生命值和15攻击力。", imageUrl: "/hextech/蛋白粉奶昔.webp" },
      { name: "裁决使", slug: "裁决使-gold", tier: "gold", description: "获得20攻击力和15%暴击几率。你对生命值低于30%的敌人造成15%额外伤害。", imageUrl: "/hextech/裁决使.webp" },
      { name: "负重爆气", slug: "负重爆气-gold", tier: "gold", description: "获得200额外生命值和15攻击力。你的冲刺技能在命中敌人时造成40-120（基于等级）物理伤害。", imageUrl: "/hextech/负重爆气.webp" },
      ...
      { name: "踢踏舞", slug: "踢踏舞-gold", tier: "gold", description: "获得15%移动速度。你的移动会积累【踢踏】层数，在10层时释放一次冲击波，对周围敌人造成40-120（基于等级）物理伤害。", imageUrl: "/hextech/踢踏舞.webp" },
      { name: "转得我眩晕了", slug: "转得我眩晕了-gold", tier: "gold", description: "获得20%攻击速度。你的旋转类技能范围增加20%。", imageUrl: "/hextech/转得我眩晕了.webp" },
      { name: "连拨击锤", slug: "连拨击锤-gold", tier: "gold", description: "获得25%攻击速度。你的攻击有20%几率触发一次额外攻击，造成50%攻击力的物理伤害。", imageUrl: "/hextech/连拨击锤.webp" },
      { name: "逃跑计划", slug: "逃跑计划-gold", tier: "gold", description: "获得15%移动速度。在生命值低于30%时，获得额外30%移动速度，持续2秒（15秒冷却时间）。", imageUrl: "/hextech/逃跑计划.webp" },
      { name: "重量级打击手", slug: "重量级打击手-gold", tier: "gold", description: "获得200额外生命值和20攻击力。你的普通攻击造成10%额外物理伤害。", imageUrl: "/hextech/重量级打击手.webp" },
      { name: "量子计算", slug: "量子计算-gold", tier: "gold", description: "获得25技能急速。你的技能急速超过50时，你的技能造成8%额外伤害。", imageUrl: "/hextech/量子计算.webp" },
      { name: "闪现向前", slug: "闪现向前-gold", tier: "gold", description: "获得15%移动速度。你的闪现冷却时间减少30%。", imageUrl: "/hextech/闪现向前.webp" },
      { name: "闪闪现现", slug: "闪闪现现-gold", tier: "gold", description: "你的闪现会在起点和终点各造成60-180（基于等级）魔法伤害。", imageUrl: "/hextech/闪闪现现.webp" },
      { name: "雪球扭蛋机", slug: "雪球扭蛋机-gold", tier: "gold", description: "获得200额外生命值。每20秒获得一个随机增益效果。", imageUrl: "/hextech/雪球扭蛋机.webp" },
      { name: "霸符兄弟", slug: "霸符兄弟-gold", tier: "gold", description: "获得30护甲和20技能急速。", imageUrl: "/hextech/霸符兄弟.webp" },
      ...
      { name: "魄罗之王的弹跳", slug: "魄罗之王的弹跳-gold", tier: "gold", description: "获得15%移动速度。你的冲刺技能距离增加20%。", imageUrl: "/hextech/魄罗之王的弹跳.webp" },
      ...
      { name: "任务：钢化你心", slug: "任务：钢化你心-prismatic", tier: "prismatic", description: "获得200额外生命值。\n\n任务：承受10000伤害。\n\n奖励：升级为钢化你心，获得600额外生命值。", imageUrl: "/hextech/任务：钢化你心.webp" },
      { name: "作弊：我能回城", slug: "作弊：我能回城-prismatic", tier: "prismatic", description: "你可以随时随地使用回城（8秒引导，120秒冷却时间）。回城完成后，回复50%最大生命值和法力值。", imageUrl: "/hextech/作弊：我能回城.webp" },
      ...
      { name: "升级：中娅", slug: "升级：中娅-prismatic", tier: "prismatic", description: "获得40法术强度和15护甲。\n\n主动—凝滞：进入凝滞状态2.5秒，期间免疫且不可选定（90秒冷却时间）。", imageUrl: "/hextech/升级：中娅.webp" },
      { name: "升级：收集者", slug: "升级：收集者-prismatic", tier: "prismatic", description: "获得30攻击力和25%暴击几率。\n\n你对生命值低于5%的敌人造成伤害时直接将其处决。击杀后获得额外25金币。", imageUrl: "/hextech/升级：收集者.webp" },
      { name: "升级：无尽之刃", slug: "升级：无尽之刃-prismatic", tier: "prismatic", description: "获得35攻击力和30%暴击几率。\n\n你的暴击伤害增加40%。", imageUrl: "/hextech/升级：无尽之刃.webp" },
      { name: "升级：狂妄", slug: "升级：狂妄-prismatic", tier: "prismatic", description: "获得40攻击力。\n\n你的攻击力增加25%。", imageUrl: "/hextech/升级：狂妄.webp" },
      { name: "升级：献祭", slug: "升级：献祭-prismatic", tier: "prismatic", description: "获得40护甲。\n\n对周围敌人每秒造成20-40（基于等级）魔法伤害。对小兵和野怪增加200%伤害。", imageUrl: "/hextech/升级：献祭.webp" },
      ...
      { name: "升级：耀光", slug: "升级：耀光-prismatic", tier: "prismatic", description: "获得25法术强度和15技能急速。\n\n施放技能后，你的下一次攻击造成100%基础攻击力的额外物理伤害。", imageUrl: "/hextech/升级：耀光.webp" },
      ...
      { name: "杀戮时间到了", slug: "杀戮时间到了-prismatic", tier: "prismatic", description: "获得30攻击力和30%暴击几率。击杀或助攻后，你的攻击速度增加50%，持续3秒。", imageUrl: "/hextech/杀戮时间到了.webp" },
      { name: "暴击飞弹", slug: "暴击飞弹-prismatic", tier: "prismatic", description: "获得30%暴击几率和30攻击力。你的暴击会发射一枚飞弹，对目标周围敌人造成50%攻击力的物理伤害。", imageUrl: "/hextech/暴击飞弹.webp" },
      ...
      { name: "质变：棱彩阶", slug: "质变：棱彩阶-prismatic", tier: "prismatic", description: "将你所有黄金阶海克斯升级为棱彩阶版本。", imageUrl: "/hextech/质变：棱彩阶.webp" },
      ...
      { name: "恶趣味", slug: "恶趣味-prismatic", tier: "prismatic", description: "获得30法术强度。你的技能命中敌方英雄时，有25%几率施加一个随机的减益效果（减速、灼烧、减攻速、减伤害）。", imageUrl: "/hextech/恶趣味.webp" },
      { name: "冰寒", slug: "冰寒-prismatic", tier: "prismatic", description: "你的减速效果可使移动速度降低额外的200。被你减速超过50%的敌人将被冻结1秒（10秒冷却时间）。", imageUrl: "/hextech/冰寒.webp" },
      ...
      { name: "吞噬灵魂", slug: "吞噬灵魂-prismatic", tier: "prismatic", description: "获得40法术强度。击杀或助攻后，获得15法术强度（至多叠加10次），死亡后损失一半层数。", imageUrl: "/hextech/吞噬灵魂.webp" },
      { name: "坚若磐石", slug: "坚若磐石-prismatic", tier: "prismatic", description: "获得60护甲和60魔法抗性。在你生命值低于30%时，额外获得40护甲和40魔法抗性。", imageUrl: "/hextech/坚若磐石.webp" },
      { name: "天音爆", slug: "天音爆-prismatic", tier: "prismatic", description: "获得40法术强度。你的技能命中3次后，下一次技能造成60额外魔法伤害并沉默目标1秒。", imageUrl: "/hextech/天音爆.webp" },
      ...
      { name: "帽上加帽", slug: "帽上加帽-prismatic", tier: "prismatic", description: "获得60法术强度。你的法术强度增加30%。", imageUrl: "/hextech/帽上加帽.webp" },
      ...
      { name: "残暴之力", slug: "残暴之力-prismatic", tier: "prismatic", description: "获得40攻击力和25护甲穿透。", imageUrl: "/hextech/残暴之力.webp" },
      ...
      { name: "超凡邪恶", slug: "超凡邪恶-prismatic", tier: "prismatic", description: "获得50法术强度。对敌方英雄造成伤害时获得1层【邪恶】，每层提供5法术强度（至多15层）。死亡后损失一半层数。", imageUrl: "/hextech/超凡邪恶.webp" },
      { name: "魔法转物理", slug: "魔法转物理-prismatic", tier: "prismatic", description: "获得40攻击力。你的法术强度25%转化为攻击力。", imageUrl: "/hextech/魔法转物理.webp" },
      { name: "物理转魔法", slug: "物理转魔法-prismatic", tier: "prismatic", description: "获得40法术强度。你的攻击力25%转化为法术强度。", imageUrl: "/hextech/物理转魔法.webp" },
      ...
      { name: "双生火焰", slug: "双生火焰-prismatic", tier: "prismatic", description: "获得50法术强度。你的单体技能在命中后会复制一次，造成50%的伤害。", imageUrl: "/hextech/双生火焰.webp" },
      { name: "闪现向前", slug: "闪现向前-prismatic", tier: "prismatic", description: "获得25%移动速度。你的闪现冷却时间减少60%。闪现后获得30%攻击速度，持续3秒。", imageUrl: "/hextech/闪现向前.webp" },
      { name: "闪闪现现", slug: "闪闪现现-prismatic", tier: "prismatic", description: "你的闪现会在起点和终点各造成100-300（基于等级）魔法伤害。闪现距离增加25%。", imageUrl: "/hextech/闪闪现现.webp" },
